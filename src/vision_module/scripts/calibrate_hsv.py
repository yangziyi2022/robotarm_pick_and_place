...
cv2.createTrackbar("H Lower", "HSV Adjustment", 0, 180, nothing)
cv2.createTrackbar("H Upper", "HSV Adjustment", 180, 180, nothing)
cv2.createTrackbar("S Lower", "HSV Adjustment", 0, 255, nothing)
cv2.createTrackbar("S Upper", "HSV Adjustment", 255, 255, nothing)
cv2.createTrackbar("V Lower", "HSV Adjustment", 200, 255, nothing)
